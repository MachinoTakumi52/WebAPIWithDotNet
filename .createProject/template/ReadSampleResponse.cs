...
public class ReadSamplesResponse
{
    ...
    /// ユーザー情報リスト
    /// </summary>
    public IEnumerable<ReadSamplesResponseDataUserModel> Users { get; set; }

    /// <summary>
    /// コンストラクタ
    /// </summary>
    /// <param name="users"></param>
    public ReadSamplesResponse(IEnumerable<ReadSamplesResponseDataUserModel> users)
    {
        this.Users = users;
    }
}
...
/// </summary>
public class ReadSamplesResponseDataUserModel
{
    /// <summary>
    /// コンストラクタ
    /// </summary>
    ...
    public ReadSamplesResponseDataUserModel(int id, string name, int age)
    {
        this.ID = id;
        this.Name = name;
        this.Age = age;
